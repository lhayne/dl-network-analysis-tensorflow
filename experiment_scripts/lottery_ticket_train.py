...
def main():
    ...
    for iteration in range(10):
        for keep_exponent in range(1,25):
            ...
            pickle.dump(dense_300_mask,open('../masks/lottery_ticket_dense_300_percent_'+str(keep_exponent)+'_iteration_'+str(iteration)+'.pkl','wb'))
            ...
            pickle.dump(dense_100_mask,open('../masks/lottery_ticket_dense_100_percent_'+str(keep_exponent)+'_iteration_'+str(iteration)+'.pkl','wb'))
