...
def main():
    ...
    for iteration in range(10):
        for keep_exponent in range(1,25):
            ...
            # Selectivity based unit pruning
            dense_300_mask = modeling.percent_highest_mask(dense_300_selectivities,percent_to_keep)
            dense_300_mask = np.reshape(dense_300_mask,(1,300))

            dense_100_mask = modeling.percent_highest_mask(dense_100_selectivities,percent_to_keep)
